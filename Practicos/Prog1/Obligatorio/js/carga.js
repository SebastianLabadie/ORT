...
personas.push(new Persona('55555555','Luis','Quiroz','luisq','1234'))
...
empresas.push(new Empresa('756371570613','razonsocial5','Mox','mox','1234',tiposVehiculos[1],'H'))
...
envios.push(new Envio(personas[6],tiposVehiculos[0],20,'queda muy lejos',fotoEnvioDefault,'Pendiente',''))
envios.push(new Envio(personas[6],tiposVehiculos[1],10,'queda muy lejos',fotoEnvioDefault,'En Transito',empresas[4]))
envios.push(new Envio(personas[6],tiposVehiculos[0],15,'queda muy lejos',fotoEnvioDefault,'Pendiente',''))
envios.push(new Envio(personas[6],tiposVehiculos[0],25,'queda muy lejos',fotoEnvioDefault,'Finalizada',empresas[3]))
envios.push(new Envio(personas[5],tiposVehiculos[2],18,'queda muy lejos',fotoEnvioDefault,'En Transito',empresas[2]))
envios.push(new Envio(personas[4],tiposVehiculos[0],5,'queda muy lejos',fotoEnvioDefault,'En Transito',empresas[3]))
envios.push(new Envio(personas[4],tiposVehiculos[0],8,'queda muy lejos',fotoEnvioDefault,'En Transito',empresas[0]))
envios.push(new Envio(personas[3],tiposVehiculos[0],14,'queda muy lejos',fotoEnvioDefault,'Pendiente',''))
envios.push(new Envio(personas[2],tiposVehiculos[1],22,'queda muy lejos',fotoEnvioDefault,'Pendiente',''))
envios.push(new Envio(personas[1],tiposVehiculos[2],40,'queda muy lejos',fotoEnvioDefault,'Pendiente',''))
